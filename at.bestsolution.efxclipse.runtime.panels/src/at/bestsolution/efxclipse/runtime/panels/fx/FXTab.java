...
/**
 * <p>Tabs are placed within a {@link FXTabPane}, where each tab represents a single
 * 'page'.</p>
...
public class FXTab implements EventTarget {
            ...
            selected = new ReadOnlyBooleanWrapper() {
                @Override protected void invalidated() {
                    if (getOnSelectionChanged() != null) {
                        Event.fireEvent(FXTab.this, new Event(SELECTION_CHANGED_EVENT));
                    }
                }
    ...
    private ReadOnlyObjectWrapper<FXTabPane> tabPane;

    final void setTabPane(FXTabPane value) {
     ...
     */
    public final FXTabPane getTabPane() {
     ...
     */
    public final ReadOnlyObjectProperty<FXTabPane> tabPaneProperty() {
        return tabPanePropertyImpl().getReadOnlyProperty();
    }

    private ReadOnlyObjectWrapper<FXTabPane> tabPanePropertyImpl() {
        if (tabPane == null) {
            tabPane = new ReadOnlyObjectWrapper<FXTabPane>(this, "tabPane");
        }
        return tabPane;
    }
     ...
     * can be selected using {@link FXTabPane#getSelectionModel()}.
     * 
     * @defaultValue false
     * @since 2.2
     */
     ...
     * be retrieved by calling {@link FXTab#getUserData()}.
     *
     * @param value The value to be stored - this can later be retrieved by calling
     *          {@link FXTab#getUserData()}.
     * @since 2.2
     */
     ...
     * has been set using the {@link FXTab#setUserData(java.lang.Object)} method.
     *
    ...
    public Styleable impl_getStyleable() {
        ...
        if (styleable == null) {
            styleable = new Styleable() {
                ...
                @Override
                public String getId() {
                    return FXTab.this.getId();
                }

                @Override
                public List<String> getStyleClass() {
                    return FXTab.this.getStyleClass();
                }

                @Override
                public String getStyle() {
                    return FXTab.this.getStyle();
                }
     ...
     * <p>
     * The callback returns <code>false</code> if the closing can proceed and <code>true</code>
     * if the close operation should be skipped
     * </p>
     * 
     * @param closeVetoHandler handler to consult before closing the tab 
     */
