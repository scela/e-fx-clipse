...
public class KeyStrokeImpl extends TriggerImpl implements EKeyStroke {
	/**
	...
	public static final EKeyStroke getInstance(EKeyLookup lookup, final String string)
	...
	private final EKeyLookup lookup;
	 ...
	 * @see SWTKeySupport
	 */
	private KeyStrokeImpl(EKeyLookup lookup, final int modifierKeys, final int naturalKey) {
