		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getCSSBaseTypeAccess().getAlternatives(), "rule__CSSBaseType__Alternatives");
					...
					put(grammarAccess.getCSSRuleLiteralAccess().getAlternatives(), "rule__CSSRuleLiteral__Alternatives");
					...
					put(grammarAccess.getCSSRuleLiteralAccess().getGroup_0(), "rule__CSSRuleLiteral__Group_0__0");
					put(grammarAccess.getCSSDefaultValueAccess().getGroup_2(), "rule__CSSDefaultValue__Group_2__0");
					...
					put(grammarAccess.getCSSRuleDefinitionAccess().getRAssignment_4(), "rule__CSSRuleDefinition__RAssignment_4");
					...
					put(grammarAccess.getCSSRuleLiteralAccess().getValueAssignment_0_1(), "rule__CSSRuleLiteral__ValueAssignment_0_1");
