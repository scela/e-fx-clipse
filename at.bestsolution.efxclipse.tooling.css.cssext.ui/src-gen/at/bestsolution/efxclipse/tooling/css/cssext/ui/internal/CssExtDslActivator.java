...
public class CssExtDslActivator extends AbstractUIPlugin {
	...
	protected Module getRuntimeModule(String grammar) {
		if (AT_BESTSOLUTION_EFXCLIPSE_TOOLING_CSS_CSSEXT_CSSEXTDSL.equals(grammar)) {
			return new at.bestsolution.efxclipse.tooling.css.cssext.CssExtDslRuntimeModule();
		}
	...
	protected Module getUiModule(String grammar) {
		if (AT_BESTSOLUTION_EFXCLIPSE_TOOLING_CSS_CSSEXT_CSSEXTDSL.equals(grammar)) {
			return new at.bestsolution.efxclipse.tooling.css.cssext.ui.CssExtDslUiModule(this);
		}
